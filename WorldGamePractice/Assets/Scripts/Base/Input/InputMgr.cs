...
{
    private Dictionary<WorldEventType, InputInfo> inputDic = new Dictionary<WorldEventType, InputInfo>();
    ...
    public void ChangeKeyboardInfo(WorldEventType eventType, KeyCode key, InputInfo.E_InputType inputType)
    {
        //初始化
    ...
    /// <param name="inputType"></param>
    public void ChangeMouseInfo(WorldEventType eventType, int mouseID, InputInfo.E_InputType inputType)
    {
        //初始化
        if (!inputDic.ContainsKey(eventType))
        {
    ...
    /// </summary>
    /// <param name="eventType"></param>
    public void RemoveInputInfo(WorldEventType eventType)
    {
        if (inputDic.ContainsKey(eventType))
    ...
    private void InputUpdate()
    {
        ...
        foreach (WorldEventType eventType in inputDic.Keys)
        {
        ...
        EventCenter.Instance.EventTrigger(WorldEventType.E_Input_Horizontal, Input.GetAxis("Horizontal"));
        EventCenter.Instance.EventTrigger(WorldEventType.E_Input_Vertical, Input.GetAxis("Vertical"));
    }
