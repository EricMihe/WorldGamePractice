...
public class SceneMgr : BaseManager<SceneMgr>
{
    ...
    private IEnumerator ReallyLoadSceneAsyn(string name, UnityAction callBack)
    {
        ...
        while (!ao.isDone)
        {
            ...
            EventCenter.Instance.EventTrigger<float>(WorldEventType.E_SceneLoadChange, ao.progress);
            yield return 0;
        }
        //避免最后一帧直接结束了 没有同步1出去
        EventCenter.Instance.EventTrigger<float>(WorldEventType.E_SceneLoadChange, 1);
